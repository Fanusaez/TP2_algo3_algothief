...
public class CiudadProductiva implements Ciudad{
    ...
    */
    ...
    public void entrarAEdificio(int indice) {
        edificios.get(indice).mostrarPista();
    ...
    public void generarPista(CiudadProductiva ciudadsiguiente, String pistaDelincuente) {
    ...
    public void agregarComoOpcion(Ciudad destino) {
        ...
        this.opcionesDeViaje.add((CiudadProductiva) destino);
    ...
    public ArrayList<CiudadProductiva> mostrarOpcionesViaje() {
